...
Karpenter improves the efficiency and cost of running workloads on Kubernetes clusters by:test

* **Watching** for pods that the Kubernetes scheduler has marked as unschedulable
* **Evaluating** scheduling constraints (resource requests, nodeselectors, affinities, tolerations, anld topotlogy spread constraints) requested by the pods
